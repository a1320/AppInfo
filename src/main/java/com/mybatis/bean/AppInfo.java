...
public class AppInfo {
	...
	public AppInfo(Long id, String softwarename, String apkname, String supportrom, String interfacelanguage,
			BigDecimal softwaresize, Date updatedate, Long devid, String appinfo, Long status, Date onsaledate,
			Date offsaledate, Long flatformid, Long categorylevel3, Long downloads, Long createdby, Date creationdate,
			Long modifyby, Date modifydate, Long categorylevel1, Long categorylevel2, String logopicpath,
			String logolocpath, Long versionid) {
		super();
		this.id = id;
